...
PRODUCTS = [
    ...
    {
        "nombre": "Cajón Soda x6 (1.5L)",
        "capacidad_litros": Decimal("1.50"),
        "tipo_envase": Producto.TipoEnvase.SIFON,
        "retornable": True,
        "precio": Decimal("13500.00"),
        "max_por_camioneta": 20,
        "unidad_venta": Producto.UnidadVenta.CAJA,
        "requiere_envase": True,
        "deposito_envase": Decimal("18000.00"),
    },
    {
